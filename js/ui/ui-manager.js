...
class UIManager {
    ...
    updateAIDebugPanel() {
        ...
        // Cabeçalho
        const aiPlayers = gameState.players.filter(p => (p.type === 'ai' || p.isAI) && !p.eliminated);
        const currentPlayer = getCurrentPlayer();
        const isAITurn = currentPlayer && (currentPlayer.type === 'ai' || currentPlayer.isAI) && !currentPlayer.eliminated;
